...
function Home () {
    ...
    function handleClick() {
        ...
        fetch('/api/messages', {
            ...
            body: JSON.stringify({
                to: number,
                body: 'Coding is like eating a hamburger'
              })
          })
        ...
        <div className="left_panel">
          <h1>
            ...
            <svg width="40" height="40" viewBox="0 0 72 61" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M6 12.8523C8.01815 17.5344 10.0188 22.0197 12.6527 26.3757C13.7248 28.1489 14.8339 29.4014 14.8339 31.5016"
                stroke="#F47865"
                strokeWidth="10"
                strokeLinecap="round"
              />
              <path
                d="M28.5752 5C31.8639 10.1386 35.9102 16.6724 37.4091 22.6677"
                stroke="#F47865"
                strokeWidth="10"
                strokeLinecap="round"
              />
              <path
                d="M10.9077 53.0955C22.6175 57.8352 33.554 56.5784 44.4982 50.1509C56.9915 42.8135 63.345 33.7651 66.8555 19.7231"
                stroke="#F47865"
                strokeWidth="10"
                strokeLinecap="round"
              />
          ...
          <div className="thought_of_day">
            ...
            <input id="number-inp" style={{marginRight: "5px"}} onChange={(e) => setNumber(e.target.value)} type="text" />
        ...
        <div className="right_panel">
          ...
          <h1 className="suggested">
            <svg width="42" height="25" viewBox="0 0 42 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M21 6.4338C15.491 -3.01971 0 -0.259955 0 11.5858C0 19.7425 9.74925 28.083 21 39.2498C32.2525 28.083 42 19.7425 42 11.5858C42 -0.300205 26.4688 -2.94971 21 6.4338Z"
                fill="#F47865"
              />
            </svg>
            You might also like
